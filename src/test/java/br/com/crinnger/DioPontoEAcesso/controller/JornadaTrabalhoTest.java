...
@WebMvcTest(JornadaTrabalhoController.class)
...
public class JornadaTrabalhoTest {
    ...
    private final String host = "/jornada";

    @TestConfiguration
    static class serviceImplTestContextConfiguration {
        @Bean
        public JornadaService service() {
    ...
    public void testGetById() throws Exception{
        JornadaTrabalho expected =new JornadaTrabalho(1L,"teste");
    ...
    public void testCreate() throws Exception {
        ...
        given(repository.save(any(JornadaTrabalho.class))).willReturn(expected);
    ...
    public void testUpdate()   throws Exception {
        JornadaTrabalho expected =new JornadaTrabalho(1L,"teste2");
