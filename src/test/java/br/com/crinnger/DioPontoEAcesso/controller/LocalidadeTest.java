...
public class LocalidadeTest {
    ...
    private final String host = "/localidade";

    private final Localidade expected = new Localidade(1L,new NivelAcesso(),"teste2");

    @TestConfiguration
    static class serviceImplTestContextConfiguration {
        @Bean
        public LocalidadeService service() {
            return new LocalidadeService();
        }
    }
    ...
    public void testCreate() throws Exception {
        ...
        given(repository.save(any(Localidade.class))).willReturn(expected);
